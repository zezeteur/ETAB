...
<head>
  ...
  <title>Connexion - NSIA DSID</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">NSIA DSID</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Veuillez entrer votre username & password</p>
                  </div>
                  ...
                  <form action="verif.php" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Veullez entrer votre username svp !</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Veullez entrer votre Mot de passe svp !</div>
                    </div>
